...
export function SeminarShortcut({ seminar }: { seminar: { title: string; date: Date } }) {
  ...
  return (
    <>
      <div className="border sm:pl-4 px-3 py-3 flex flex-col sm:flex-row flex-nowrap justify-between sm:items-center bg-brand text-white border-brand rounded-md sm:rounded-full">
        <div>
          <h3 className="leading-none font-semibold">{seminar.title}</h3>
        ...
        <button
          ...
          className="flex flex-row items-center bg-white font-semibold rounded-full py-2 px-3 text-nowrap text-xs text-brand w-full sm:w-auto mt-2 sm:mt-0 hover:bg-white/90 transition-all"
        >
          <svg
